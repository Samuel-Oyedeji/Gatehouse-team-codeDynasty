...
import { n as HTTPError, o as NodeResponse, r as defineLazyEventHandler, s as toNodeHandler, t as H3Core } from "./_libs/h3+rou3+srvx.mjs";
...
var _lazy_b1Ec_X = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_b1Ec_X
	};
	return ((_m, p) => {
		return {
			data,
