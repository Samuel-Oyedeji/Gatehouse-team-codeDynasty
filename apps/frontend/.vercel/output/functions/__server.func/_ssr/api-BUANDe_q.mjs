...
//#region node_modules/.nitro/vite/services/ssr/assets/api-BUANDe_q.js
...
async function renameBillingRunFn({ data }) {
	return request("PATCH", `/billing/run/${data.runId}`, { cycleLabel: data.cycleLabel });
}
...
//#endregion
export { resolveAccountFn as A, getToken as C, provisionUnitsFn as D, payVendorFn as E, updateFeeStructureFn as F, updateUnitFn as I, updateVendorFn as L, signupFn as M, simulatePayment as N, renameBillingRunFn as O, updateEstateFn as P, getQueryClient as S, logoutFn as T, fetchEstateState as _, apiUrl as a, fetchStreamTicket as b, createEstateFn as c, deleteGroupFn as d, deleteUnitFn as f, fetchCurrentUser as g, fetchBanksFn as h, addVendorFn as i, resolveExceptionFn as j, resetDemoFn as k, createGroupFn as l, fetchAccountBalance as m, BANKS_KEY as n, assignUnitGroupFn as o, deleteVendorFn as p, ESTATE_STATE_KEY as r, createBillingRunFn as s, ACCOUNT_BALANCE_KEY as t, createLevyFn as u, fetchOnboardingState as v, loginFn as w, getEstateId as x, fetchPublicStatement as y };
